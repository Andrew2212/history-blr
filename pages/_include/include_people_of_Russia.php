<meta content="text/html; charset=utf-8" http-equiv="Content-Type">
   				...
   				<!-- *** Descripton all people of Russia *** -->
		...
		<div class="col-md-12">
			...
			Этот труд вышел в Санкт-Петербурге в на немецком (родном языке императрицы Екатерины II) под названием 
		...
		<h2>
			...
			</br><small>Хорошая отправная точка для рассмотрения миграции терминов "Русь", "Белая Русь", "Литва".
			</small>
		</h2>
		...
		<p>
			...
			"Чернь или Простолюдины Польские <a href="../terms/religion_blr.php">разного вероисповедания</a>".
