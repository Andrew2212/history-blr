...
<? include ("../_include/dir_articles.php"); ?>
    ...
    <? include ("../_include/top_list_articles.php"); ?>
		...
		</br>For the good of all of us.
		</br>Except the ones who are dead." (с)
		</i>
		</p>
		...
		<p>
		Первое, что делает человек, заходя в руины древнего храма — внимательно смотрит под ноги. Помимо практических соображений, в душе живет 
		детское желание что-то найти. Монету. 
		</p>
		<p>
		Логика говорит: "Тут ничего нет". Иррациональное шепчет: "Это место — туннель времени. Эти стены стоят четыреста лет. 
		Надо только хорошо посмотреть!" Это как найти в прибое "куриного бога". Непонятно зачем, но хочется. 
		</p>
		<p>
		Есть вещи, которые приятно поглаживать, рассматривать и держать при себе. А есть — которые уместны только в домашней коллекции под стеклом.
		В архаичных вещах до-индустриальной эпохи есть нечто наивно-завораживающее.
		</p>
				
		<div class="col-md-12 img-float-center">
		
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/henseGod.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Куриный бог" src="../../images/img-articles/taler_blr/henseGod_thumb.jpg" height="100">
		</br><small>"Куриный бог"</small>
		</a>
		</div>
		
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/us_marshal.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Жетон маршала" src="../../images/img-articles/taler_blr/us_marshal_thumb.jpg" height="100">
		</br><small>Жетон маршала</small>
		</a>
		</div>
		
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/tallinn.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Значки, Таллинн" src="../../images/img-articles/taler_blr/tallinn_thumb.jpg" height="100">
		</br><small>Значки, Таллинн</small>
		</a>
		</div>
		...
		От <a href="../figures/vyten.php">в. князя Витеня</a> до <a href="../events/razbor_rechi.php">разделов Речи Посполитой</a>.
		 Первая монета за 220 лет (ладно, "монетовидный жетон", Ок).
		</p>
		<p> 
		Проходя по гродненской брукаванке, хотелось поглаживать пальцами монету со старым гербом. 
		Хотелось иметь возможность подарить приехавшим знакомым пристойный сувенир, а не пост-совковый трэш или китч с гербом на всю грудь. 
		И дать такую возможность любому из тех, кому это интересно. 
		</p>
		<p>
		...
		</br><small>Оттиск чернового штампа</small>
		</a>
		</div>
		...
		<p>
		Да, были еще "боратинки" (арендатор Брестского монетного двора — Тит Ливий <i>Боратини</i>) с Погоней при Яне II Казимире Ваза (1648-1668), возможно, что-то еще. 
		Однако, "Погоня" Сигизмунда Августа, пожалуй, самая стильная своей наивностью, свойственной монетам середины XVI века. 
		</p>
		<p>
		Кроме того, на монетах Сигизмунда хорошо закомпонованы Погоня и <a href="../terms/kalumny.php">Калюмны</a> — наш старый символ, не отраженный даже в банкнотах. 
		</p>
		<p>
		В правление Сигизмунда Августа была заключена <a href="../events/unia_liublin.php">Люблинская уния</a> (1569 год) — Польша и ВКЛ образовали 
		<a href="../terms/rzeczpospolita.php">Речь Посполитую</a>. Следующий в. князь — <a href="../events/confederacia_warshawa.php">Генрих Валуа</a>, 
		— монету, вроде, не чеканил (правил январь-июнь 1574, потом стал королем Франции). А при <a href="../figures/batory.php">Стефане Батории</a>
		(в. князь 1575-1586) на монете чеканили уже полный герб Речи Посполитой. 
		</p>
		<p>
		<i>"Сигизмунд II не понял бы надпись Belarus — ее тогда не было!"</i>. Он не понял бы даже карту 1739 
		<a href="../download/map_wkl.php">"Regnum Poloniae et Magni Ducatus Lithuaniae"</a>, Matthias Seutter 
		— там Russia Alba и Magni Ducatus Lithuaniae обозначают одно и то же географическое понятие. Мир меняется, знаете ли.
		</p>
		<p>
		Написание "Belarus" через "V" — обычная практика для монет того времени и латинского написания вообще. 
		"Ducatus" и "Sigismund" так же писались черз "v". 
		</p>
		<p>
		Сокращение названия "Magni Ducatus Lithuaniae", как "M. D. Litva" не хуже и не лучше многообразных вариантов сокращений этого названия, 
		применявшихся монетными дворами. Хотя против восприятия надписи как "Беларусь-Литва-одна история" тоже ничего не имею.
		</p>
		...
		</br><small>1663-66 "Боратинки" Яна Казимира</small>
		</a>
		</div>
		...
		<p>
		В обществе просыпается интерес к своей истории. Восстановлен Несвижский замок, строится парк миниатюр крепостей и храмов, 
		энтузиасты проводят экскурсии по старым руинам. 
		И обычное человеческое желание прикоснуться (буквально) и унести с собой нечто, хоть немного аутентичное, натыкается на грустный ответ — "Нету!".
		</p>
		<p>
		<i>"Все идут к истокам, ищут культурную идентичность. Все пытаются определиться и найти свое место через обращение к очень простым формулам 
		своей культурной идентичности. Был создан огромный мировой рынок, где происходит конкуренция.
		</p>
		<p>
		Для того чтобы удачно конкурировать, нужно иметь то, что называется "человеческий капитал", а это и есть основы — семья, своя старая культура, 
		традиция,"</i> — Б. Гройс, советский и немецкий искусствовед, профессор философи, писатель, публицист. 
		</p>
		...
		</br><small>1584 Гербы воеводств</small>
		</a>
		</div>
		...
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/2011_Capitalist Digital.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Беларуский талер с Погоней" src="../../images/img-articles/taler_blr/2011_Capitalist Digital_thumb.jpg" height="100">
		</br><small>Эскизы 2011</small>
		</a>
		</div>
		
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/2007_banknote.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Беларуский талер с Погоней" src="../../images/img-articles/taler_blr/2007_banknote_thumb.jpg" height="100">
		</br><small>Эскизы 2007</small>
		</a>
		</div>
		
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/1993_banknote.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Беларуский талер с Погоней" src="../../images/img-articles/taler_blr/1993_banknote_thumb.jpg" height="100">
		</br><small>Эскизы 1993</small>
		</a>
		</div>
		
		<div class="col-md-3">
		<a href="../../images/img-articles/taler_blr/1993_blr.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Беларуский талер с Погоней" src="../../images/img-articles/taler_blr/1993_blr_thumb.jpg" height="100">
		</br><small>Эскизы 1993</small>
		</a>
		</div>
		...
		<p>
		Справочник "Монеты Беларуси до 1707 года" можно посмотреть <a href="../download/monet_blr.php">ТУТ</a>
		</p>
		
		<h3>PPS.</h3>
		
		<p>
		И да, нам очень лестно, что фотогафия талера из этого проекта была использована 
		<a target="_blank" href="https://cryptotaler.blogspot.com.by/">в анонсе</a> первой белорусской криптовалюты!
		</p>
		<p class="img-float-center">
		<a href="../../images/img-articles/taler_blr/criptoTaler.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Беларуский талер с Погоней" src="../../images/img-articles/taler_blr/criptoTaler_thumb.jpg" height="100">
		</a>
		</p>
		<p>
		<i>
		"Мы инициировали создание первой белорусской криптовалюты с той целью, чтобы экономический рост шёл «снизу», через человека как единственное мерило экономических отношений, через самозанятых белорусов, через малый бизнес и стартапы, через исключение из нашей жизни множества алчных посредников (например, банков в их нынешнем виде) и ненужных регуляторов (большинство госчиновников).
		</i>
		</p>
		<p>
		<i>
		Когда экономические отношения между людьми свободны и регулируются исключительно законами рынка и результатами их труда, экономический рост становится неизбежен. Примеров тому в новейшей истории множество – от Гонконга до Польши. Созданный нами Талер – инструмент именно таких – свободных – экономических отношений в белорусском обществе."
		</i>
		</p>
		
		<p class="img-float-center">
		<a href="../../images/img-articles/taler_blr/archStub.jpg" class="highslide"
        onclick="return hs.expand(this)">
		<img alt="Беларуский талер с Погоней" src="../../images/img-articles/taler_blr/archStub_thumb.jpg" height="100">
		</a>
		</p>

		</br></br></br>
		http://iger.wcn.pl/coins</br>
		http://finance.tut.by/news471475.html</br>
		http://sgustok.org/blogs/novye-belorusskie-dengi</br>
		https://charter97.org/ru/news/2016/9/9/221614/</br>
