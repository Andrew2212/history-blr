...
<? include ("../_include/dir_terms.php"); ?>
    ...
    <div class="col-md-8">
		...
		<p>
			<i>"Национальлный язык — социально-историческая категория, которая обозначает язык, являющийся средством общения нации и 
			выступающий в двух формах: устной и письменной. 
			</br>Н. я. формируется вместе с образова­нием нации, являясь одновременно предпосылкой и условием её возникновения и существования, 
		...
		<p>	
			...
			</br>100 лет — польский и латынь. В 1696 году Всеобщая конфедерация сословий (конфедеративный сейм) Речи Посполитой приняла постановление о том, 
			что в ВКЛ государственные документы должны писаться не на белорусском, а на польском и латинском языках
			</br>200 лет — с 1795 года, после раздела Речи Посполитой, и до 1991 года — государственным языком был русский.	
		</p>
	...
	<div class="col-md-12" >
		...
		<p>
		On-line словарь <a href="http://adpavedniki.esy.es/">тут</a>.
		</br>Возвращение  <a href="http://www.svaboda.org/content/viacorka-miakki-znak/26972870.html">классическиого правописания</a>.
		</p>		
		<p>
