...
<? include ("../_include/dir_terms.php"); ?>
	...
	<div class="col-md-12">
		...
		<p>
		У истоков БНР стояли умные, образованные люди, стремившиеся к возрождению белорусской истории и культуры, независимости Беларуси.
		Все они видели в БНР продолжение традиций <a href="../terms/wkl.php">ВКЛ</a>. Достаточно перечислить некоторых из тех, кто не дал Краю раствориться в новой империи.
		</p>		
		<p>
