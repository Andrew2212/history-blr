...
<? include ("../_include/dir_places.php"); ?>
    ...
    <div class="col-md-8">
		...
		<p>
		<i>"...вся новая топонимика РБ, календарь дат и событий, государственная символика — ничто не проникает в историю глубже 1924 года." 
		В таком контексте даже древние названия теряют свой смысл.
		</i>
		</br><small><a href="../articles/essay.php"> Эссе</a></small>
		</p>
		...
		В Летуве — Жемайтишки, в России — Мамаев Курган, Бахчисарай, Инсар.
	  
		</p>
		

		<p class="img-float-center">
			</br><a href="wostra_brama.php">Вострая Брама</a> на обложке Виленского альбома.
			</br>Это ее вспоминает <a href="../figures/bogdanowich.php">поэт</a> в национальном <a href="../terms/blr_hymn.php">гимне</a>
		</p>
			
		<p class="img-float-center">
			<img src="../../images/img-places/vostraja_brama.jpg" />
		</p>
	</div>
