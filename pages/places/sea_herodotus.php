...
<? include ("../_include/dir_places.php"); ?>
    ...
    <? include ("../_include/top_list_places.php"); ?>
		...
		</br>в болотах я родився і зріс,
		</br>я люблю свою хату поліську,
		</br>я люблю свій зажурений ліс.
		</p>
		<p>
		Що там тропіки, пишні Пампаси,
		</br>загляніть но у душу до нас,
		</br>я оддав би за неї одразу
		</br>і Тібет, і Урал, і Кавказ.
		</p>
		<p>
		А поліські похмурні болота
		</br>пів-Полісся вода зайняла,
		</br>тільки де-не-де хутір самотній,
		</br>тільки де-не-де клапоть села.
		</p>
		<p>
		І не дивно, що любимо змалку
		</br>буйні води і буйні пісні,
		</br>наше серце - то серце рибалки,
		</br>а життя наше - книга борні.
		</p>
		<p>
		Хоч у злиднях живемо, у бруді,
		</br>та привілля яке по весні,
		</br>коли виставиш вітрові груди
		</br>і летиш, і летиш на човні.
		</p>
		<p>
		А вода і хлюпоче, і плаче,
		</br>захлинається в лютій злобі,
		</br>ну скажіть, в кого серце гаряче,
		</br>як весну, по весні не любить.
		</p>
		<p>
		І укриють безкраї простори
		</br>білокурі чайки і човни,
		</br>тільки слухай, як води говорять
		</br>в буйнім заспіві свята весни.
		</p>
		<p>
		Тільки слухай, як хвилі хлюпочуть,
		</br>як нестримано повінь гуде,
		</br>зайвий рух - і на обрій заскочиш,
		</br>зайвий рух - і навік пропадеш.
		</p>
		<p>
		А коли зарегоче негода,
		</br>отоді не кепкуй із води,
		</br>як для неї чортяки не вгодиш,
		</br>ох, зазнаєш ти брате біди.
		</p>
		<p>
		Так гартує природа до бою
		</br>нас із самих малесеньких літ,
		</br>ми зрослись, побратались з водою
		</br>і живемо, як вміємо жить.
		</p>
		<p>
		<small>Фалькоўскі, уражэнец Кобрынскага раёну</smalL>
		</p>
		...
		<p><small>
		http://budzma.by/news/yak-na-palyessi-budavali-chyhunku-fota.html</br>
		http://amatary.by/polese-gremuchaya-smes-kultur/</br>
		http://www.wdl.org/ru/item/2579/</br>
		http://chronologia.org/rare/schedel/index.html</br>
