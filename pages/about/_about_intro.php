...
<? include ("../_include/dir_about.php"); ?>
    ...
    <div class="col-md-8">
		...
		</br>И, да — не надо сразу кричать: "Фошизды!", "Дедывоевали!" — <a href="../articles/blr_nationalist.php">эту статью</a> стоит прочесть 
		(кстати, она в "Лучшем-2014" у вполне респектабельного издательства)
		<p>
