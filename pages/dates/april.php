		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<ul>
							<li>Дзень дзяржаўнасьці <a href="../terms/blr_mova.php">беларускае мовы</a> —
				...
				<tr>
					...
					<td>
						<ul>
							...
							<a href="../figures/woinillovicz.php">Эдварда Войниловича</a>
							</li>
						</ul>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<ul>
							<li>1868 Родился <a href="../figures/skirmunt.php">Роман Скирмунт</a>
