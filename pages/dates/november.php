		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<ul>
							<li>1883 Родился <a href="../figures/godlewski.php">Винцент Годлевский</a> 
				...
				<tr>
					...
					<td>
						<ul>
							<li>1700 В битве под Олькениками против шляхетской конфедерации Сапеги проиграли 
							<a href="../events/war_civil_1696.php">Гражданскую войну 1696-1702 гг</a>  
							и утратили господство в ВКЛ
							</li>
							<li>1883 Родился <a href="../figures/lesik.php">Язэп Лесик</a> — Председатель Рады БНР и академик АН БССР, писатель, публицист, языковед, педагог.
							</li>
						</ul>
					</td>
				</tr>
