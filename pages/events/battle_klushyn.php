...
<? include ("../_include/dir_events.php"); ?>
    ...
    <? include ("../_include/top_list_events.php"); ?>
		...
		<p>
		<i>
		"В многократных схватках с неприятелем мы истратили военные снаряды и ослабели в силах; 
		наши кони изнемогали, а воины, сражаясь непрестанно, от рассвета летнего дня до обеда, наверное пять часов, 
		потеряли и бодрость и охоту в усилиях свыше природы человеческой.
		</p>		
		<p> 
		Более всего ужасала нас мысль, что мы находились среди земли неприятельской, в виду врагов многочисленных и жестоких: 
		отбиться от них нельзя было и подумать; испросить пощаду также казалось невозможным: спасение наше зависело единственно от Бога, счастья и оружия.
		</p>		
		<p> 
		...
		<p>
		Остатки московской армии разбежались, и она фактически перестала существовать. 
		Армия Речи Посполитой усилилась тремя тысячами бывших наемников, перешедших на службу к <a href="../terms/dukes_wkl.php">Сигизмунду III</a>, 
		и восьмитысячным русским войском Валуева, присягнувшим королевичу Владиславу после поражения. 
		</p>		
