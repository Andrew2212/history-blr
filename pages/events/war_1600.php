...
<? include ("../_include/dir_events.php"); ?>
    ...
    <? include ("../_include/top_list_events.php"); ?>
		...
		<a href="../../images/img-events/war_1600/Karl_IX.jpg" class="highslide"
        onclick="return hs.expand(this)">
			<img alt="Карл IX" src="../../images/img-events/war_1600/Karl_IX.jpg" height="140" >
			</br><small>Карл IX</small>
			</a>
		</p>
