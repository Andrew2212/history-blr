...
<!-- ***Meta*** -->  
    <meta name="description" content="Тринадцатилетним Кровавым Потопом стала для ВКЛ-Беларуси агрессия Московиии в 1654-1667 гг., 
	когда после Переяславской Рады, 
	получив в союзники Войско Запорожское, Москва вторглась в ВКЛ" />
	<meta name="keywords" itemprop="keywords" content="Кровавый Потоп, тринадцатилетняя война,
...
<? include ("../_include/dir_events.php"); ?>
    ...
    <? include ("../_include/top_list_events.php"); ?>
		...
		<p>
		Если для Королевста Польского в <a href="../terms/rzeczpospolita.php">Речи Посполитой</a> "Кровавым Потопом" была война со Швецией 1655-1660 гг., то для ВКЛ им
		...
		— под определение попадало более 80% населения.
		</p>
		<p>
		<i>
		"Наконец приехали мы в Вильну , или лучше пожарище Вильны. Москвитяне владели этим городом до 1661 года. 
		В бытность их в несчастном городе они столько совершили в нем убийств, насилий женщинам, грабежей, святотатств, разорений 
		и пожаров, что если кто вздумал бы ныне искать Вильны в городе Вильне, тот найдет только плачевные следы одичалого неистовства 
		в ее разрушении, пепле и развалинах...
		</i>
		</p>
		<p>
		<i>
		5-го Октября  мы прибыли в Минск (Minscum), главный город Минского Воеводства, расположенный на холмах и реке и удостоенный чести иметь 
		Верховный Суд для всей Литвы, кроме Вильны, каждые три года поочередно с Новогородецким. Грустным взором мы смотрели на разорение, 
		причиненное этому городу Москвитянами. Базилиане (униаты), Доминиканцы, Бернардинцы начали уже там поправлять свои разрушенные 
		святые обители и церкви, с помощью подаяний благочестивых людей. Отцы Иезуитского Общества тоже готовились положить основание 
		учреждению там своего Коллегиума.
		"
		</i>
		</br><small>Августин Мейерберг, 
		<a target="_blank" href="http://www.vostlit.info/Texts/rus11/Meierberg2/text5.phtml?id=850">«Путешествие в Московию»</a>, 1661</small>
		</p>
		<p>
		В 1658 году состоялась первая попытка создать <a href="../terms/rzeczpospolita_treh_narodov.php">Речь Посполитую Трех Народов</a>, 
		...
		<p>
		Среди событий этой войны в хрониках остались и "Трубецкая резня" (уничтожение жителей Мстиславля князем Трубецким) — 
		<i>"шляхты, поляков и литвы, и иных служилых людей… побито больше 10 тысяч человек"</i>.
		И уничтожение <a href="../terms/bastards.php">"белорусскими казаками"</a> еврейской общины Могилева после захвата города московским войском. 
