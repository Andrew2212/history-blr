...
<!-- ***Meta*** -->  
	...
	<meta property="og:image" content="http://history-belarus.by/images/img-events/sinie_wody/sinie_wody.jpg" />
...
<? include ("../_include/dir_events.php"); ?>
    ...
    <? include ("../_include/top_list_events.php"); ?>
		...
		<img alt="Битва на Синих Водах" src="../../images/img-figures/olgerd/olgerd.jpg" height="160">
		...
		<a href="../../images/img-events/sinie_wody/sinie_wody.jpg" class="highslide"
       	onclick="return hs.expand(this)">
		<img alt="Битва на Синих Водах" src="../../images/img-events/sinie_wody/sinie_wody_thumb.jpg" height="160">
		...
		<div class="col-md-6 img-float-center">
        	...
        	onclick="return hs.expand(this)">
			<img alt="Битва на Синих Водах" src="../../images/img-figures/gedimin/wkl_13-14ce_thumb.jpg" height="160">
		...
		<div class="col-md-6 img-float-center">
        	...
        	onclick="return hs.expand(this)">
			<img alt="Битва на Синих Водах" src="../../images/img-events/sinie_wody/sinie_wody_place_thumb.jpg" height="160">
