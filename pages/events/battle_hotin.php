...
<!-- ***Title*** -->
    <title>Битвы под Хотином. История Беларуси</title>
<!-- ***Meta*** -->  
    <meta name="description" content="Битва под Хотином 1621 года — победа войска Речи Посполитой над армией Османской империи. 
    Это была последняя битва великого воина и полководца Яна Ходкевича. 24 сентября тяжело больной Ходкевич умер. 
	Экспансия турок была остановлена.
...
<? include ("../_include/dir_events.php"); ?>
    ...
    <? include ("../_include/top_list_events.php"); ?>
		...
		<p>
		Хотинская битва 1621 года — сражение войска <a href="../terms/rzeczpospolita.php">Речи Посполитой</a> под командованием великого 
		гетмана литовского <a href="../figures/hodkewich.php">Яна Кароля Ходкевича</a> с армией Османской империи. 
		</br>Завершающий эпизод турецкой войны 1620-21 гг.
		</p>
		<p>
		...
		Великий гетман коронный Станислав Жолкевский был убит, а польный гетман коронный Станислав Конецпольский попал в плен. 
	...
	<div class="col-md-12">
		...
		<p>
		Разгром турок был полным. Только нескольким тысячам из 35-тысячного войска удалось уйти в занятый турками Каменец.
		Остатки турецкой армии были уничтожены или взяты в плен.
