...
<? include ("../_include/dir_figures.php"); ?>
    ...
    <? include ("../_include/top_list_figures.php"); ?>
		...
		<p>
		<i>
		В Испании Долина Павших примирила франкистов и республиканцев еще в 1940 году. В России Врангелю ставят памятники. О Несторе Махно снимают фильмы. Имя Булак-Балаховича остается табу на земле, за которую он сражался.
		</i>
		</p>
		<p>
