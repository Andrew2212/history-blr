...
<!-- ***Title*** -->
    <title>Битва на реке Ведрошь. История Беларуси</title>
<!-- ***Meta*** -->  
    <meta name="description" content="Битва на реке Ведрошь. 
	...
	<meta name="keywords" itemprop="keywords" content="Битва на реке Ведрошь, 
...
<? include ("../_include/dir_events.php"); ?>
    ...
    <? include ("../_include/top_list_events.php"); ?>
		...
		<p>
		Битва на реке Ведрошь 14 июля 1500 - сражение войны с Московией 1500-1503 гг.
		</br>Войска ВКЛ под командованием Костантина Острожского потерпели поражение.
		</br>Великое княжество Литовское потеряло примерно треть своей территории, в том числе северо-восточную Украину.
		</p>
