...
<? include ("../_include/dir_download.php"); ?>
    ...
    <? include ("../_include/top_list_download.php"); ?>
		...
		<div class="col-md-12">
			...
			Карта была напечатана в 1539 в Венеции в количестве всего нескольких экземпляров 
			с посвящением Патриарху Венецианской республики Hieronymo Quirino, 
			при поддержке которого Олаф смог закончить работу. 
		...
		<div class="col-md-12">
			...
			<img src="../../images/img-download/16_vek/1556_munster_polands_littaw_DET_thumb.jpg" class="img-float-left"/>
		...
		<div class="col-md-12">
			...
			<img src="../../images/img-download/16_vek/1552_Munster_ Nova Tabula_thumb.jpg" class="img-float-left"/>
			1552, Sebastian Munster — Polonia et Ungaria XX Nova Tabula	
			</p>
			<p>
		...
		<div class="col-md-12">
			...
			<img src="../../images/img-download/16_vek/1552_ Munster_hand_colored_thumb.jpg" class="img-float-left"/>
			1552, Sebastian Munster — Polonia et Ungaria , hand colored
			</p>
			<p>
